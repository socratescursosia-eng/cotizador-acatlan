...
tabla_precios = {
    ...
    "Doble Carta": {"Color": [8, 8, 10, 10, 10, 12, 12, 14, 14.5, 15, 16], "B&N": [2, 3.5, 5.5, 7.5, 7.5, 9, 9, 10.5, 11, 11.5, 12]},
    "Carta/Oficio": {"Color": [5, 5, 6, 6, 6, 7, 7, 8, 9, 10, 11], "B&N": [1, 2, 3, 4.5, 4.5, 5, 5, 5.5, 6, 7, 8]}
}
